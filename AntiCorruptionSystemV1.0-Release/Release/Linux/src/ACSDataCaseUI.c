...
void on_case_add_clicked(GtkWidget * widget, gpointer data)
{
    ...
    gtk_entry_set_max_length(GTK_ENTRY(numberentry), 13);
    gtk_entry_set_max_length(GTK_ENTRY(dateentry), 11);
    gtk_entry_set_max_length(GTK_ENTRY(defendantentry), 7);
    gtk_entry_set_max_length(GTK_ENTRY(amountentry), 41);
    gtk_entry_set_max_length(GTK_ENTRY(punishmententry), 11);

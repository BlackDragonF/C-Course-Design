...
void show_sidebar(void)
{
    ...
    gtk_label_set_markup(GTK_LABEL(datalabel), "<span foreground='#FFFFF7' font_desc='15'>数据维护</span>");
    gtk_fixed_put(GTK_FIXED(sidebar_fixed), datalabel, 76, 224);
    ...
    gtk_label_set_markup(GTK_LABEL(querylabel), "<span foreground='#FFFFF7' font_desc='15'>数据查询</span>");
    gtk_fixed_put(GTK_FIXED(sidebar_fixed), querylabel, 76, 404);
    ...
    gtk_label_set_markup(GTK_LABEL(stasticallabel), "<span foreground='#FFFFF7' font_desc='15'>数据统计</span>");
    gtk_fixed_put(GTK_FIXED(sidebar_fixed), stasticallabel, 76, 584);
...
void show_dataview(void)
{
    ...
    gtk_label_set_markup(GTK_LABEL(typelabel), "<span foreground='#60646d' font_desc='19.5'>选择数据类型</span>");
    gtk_fixed_put(GTK_FIXED(dataview), typelabel, 527, 170);

    province = gtk_image_new_from_file("img/highlighted_province.png");
    GtkWidget * provincelabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(provincelabel), "<span foreground='#60646d' font_desc='15'>所属省份</span>");
    gtk_fixed_put(GTK_FIXED(dataview), provincelabel, 339, 335);
    ...
    gtk_label_set_markup(GTK_LABEL(caselabel), "<span foreground='#60646d' font_desc='15'>贪腐案件</span>");
    gtk_fixed_put(GTK_FIXED(dataview), caselabel, 555, 335);
    ...
    gtk_label_set_markup(GTK_LABEL(medialabel), "<span foreground='#60646d' font_desc='15'>媒体报道</span>");
    gtk_fixed_put(GTK_FIXED(dataview), medialabel, 771, 335);
    ...
    gtk_label_set_markup(GTK_LABEL(confirmlabel), "<span foreground='#FFFFF7' font_desc='19.5'>确认</span>");
    gtk_fixed_put(GTK_FIXED(dataview), confirmlabel, 564, 400);
...
void show_queryview(void)
{
    ...
    GtkWidget * provincelabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(provincelabel), "<span foreground='#60646d' font_desc='19.5'>所属省份监管信息查询</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(pronamelabel), "<span foreground='#FFFFF7' font_desc='15'>按省份名称查找</span>");
    gtk_fixed_put(GTK_FIXED(queryview), pronamelabel, 350, 190);
    ...
    gtk_label_set_markup(GTK_LABEL(chargenamelabel), "<span foreground='#FFFFF7' font_desc='15'>按纪检负责人姓名查找</span>");
    gtk_fixed_put(GTK_FIXED(queryview), chargenamelabel, 683, 190);

    GtkWidget * caselabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(caselabel), "<span foreground='#60646d' font_desc='19.5'>贪腐案件基本信息查询</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(casenumberlabel), "<span foreground='#FFFFF7' font_desc='15'>按案件编号查找</span>");
    gtk_fixed_put(GTK_FIXED(queryview), casenumberlabel, 350, 355);
    ...
    gtk_label_set_markup(GTK_LABEL(namelevellabel), "<span foreground='#FFFFF7' font_desc='15'>按被告姓名和行政级别查找</span>");
    gtk_fixed_put(GTK_FIXED(queryview), namelevellabel, 673, 355);

    GtkWidget * medialabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(medialabel), "<span foreground='#60646d' font_desc='19.5'>媒体报道基本信息查询</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(numbernamelabel), "<span foreground='#FFFFF7' font_desc='15'>按案件编号和媒体名称查找</span>");
    gtk_fixed_put(GTK_FIXED(queryview), numbernamelabel, 318, 520);
    ...
    gtk_label_set_markup(GTK_LABEL(datenamelabel), "<span foreground='#FFFFF7' font_desc='15'>按报道日期和媒体名称查找</span>");
    gtk_fixed_put(GTK_FIXED(queryview), datenamelabel, 673, 520);
...
void show_stasticalview(void)
{
    ...
    gtk_label_set_markup(GTK_LABEL(chargelabel), "<span foreground='#60646d' font_desc='15'>以主要罪名为条件分别统计历年来各种罪名贪腐案件的发生数和涉案金额，并降序输出。</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(chargetitle), "<span foreground='#FFFFF7' font_desc='15'>按主要罪名统计</span>");
    gtk_fixed_put(GTK_FIXED(stasticalview), chargetitle, 727, 140);

    GtkWidget * levellabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(levellabel), "<span foreground='#60646d' font_desc='15'>以行政级别为条件分别统计某年度内各种行政级别贪腐案件的发生数和涉案金额并统计不同刑期的案件\n分别是多少起。</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(leveltitle), "<span foreground='#FFFFF7' font_desc='15'>按行政级别统计</span>");
    gtk_fixed_put(GTK_FIXED(stasticalview), leveltitle, 727, 250);

    GtkWidget * provincelabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(provincelabel), "<span foreground='#60646d' font_desc='15'>以案件发生地所属省份为条件分别统计某个时间段内各省份贪腐案件的发生数，涉案金额总数，并降序\n输出。</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(provincetitle), "<span foreground='#FFFFF7' font_desc='15'>按所属省份统计</span>");
    gtk_fixed_put(GTK_FIXED(stasticalview), provincetitle, 727, 360);

    GtkWidget * reportlabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(reportlabel), "<span foreground='#60646d' font_desc='15'>统计媒体报道数最多的10个贪腐案件，输出案件编号、被告行政级别、主要罪名、涉案金额、刑事处罚\n和媒体报道次数，并降序输出。</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(reporttitle), "<span foreground='#FFFFF7' font_desc='15'>按媒体报道统计</span>");
    gtk_fixed_put(GTK_FIXED(stasticalview), reporttitle, 727, 470);

    GtkWidget * amountlabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(amountlabel), "<span foreground='#60646d' font_desc='15'>统计涉案金额数最大的10个贪腐案件，输出案件编号、被告姓名、被告行政级别、主要罪名、涉案金额\n和刑事处罚，并降序输出。</span>");
    ...
    gtk_label_set_markup(GTK_LABEL(amounttitle), "<span foreground='#FFFFF7' font_desc='15'>按涉案金额统计</span>");
    gtk_fixed_put(GTK_FIXED(stasticalview), amounttitle, 727, 580);

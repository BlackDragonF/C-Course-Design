...
void show_sidebar(void)
{
    ...
    gtk_fixed_put(GTK_FIXED(sidebar_fixed), datalabel, 75, 224);
    ...
    gtk_fixed_put(GTK_FIXED(sidebar_fixed), querylabel, 75, 404);
    ...
    gtk_fixed_put(GTK_FIXED(sidebar_fixed), stasticallabel, 75, 584);
...
void show_dataview(void)
{
    ...
    gtk_fixed_put(GTK_FIXED(dataview), typelabel, 525, 170);
    ...
    gtk_fixed_put(GTK_FIXED(dataview), confirmlabel, 567, 402);
...
void show_queryview(void)
{
    ...
    gtk_fixed_put(GTK_FIXED(queryview), pronamelabel, 355, 192);
    ...
    gtk_fixed_put(GTK_FIXED(queryview), chargenamelabel, 683, 192);
    ...
    gtk_fixed_put(GTK_FIXED(queryview), casenumberlabel, 355, 357);
    ...
    gtk_fixed_put(GTK_FIXED(queryview), namelevellabel, 673, 357);
    ...
    gtk_fixed_put(GTK_FIXED(queryview), numbernamelabel, 318, 522);
    ...
    gtk_fixed_put(GTK_FIXED(queryview), datenamelabel, 673, 522);
...
void show_stasticalview(void)
{
    ...
    gtk_label_set_markup(GTK_LABEL(chargelabel), "<span foreground='#60646d' font_desc='Microsoft YaHei 15'>以主要罪名为条件分别统计历年来各种罪名贪腐案件的发生数和涉案金额，并降序输出。</span>");
    ...
    gtk_fixed_put(GTK_FIXED(stasticalview), chargetitle, 725, 143);

    GtkWidget * levellabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(levellabel), "<span foreground='#60646d' font_desc='Microsoft YaHei 15'>以行政级别为条件分别统计某年度内各种行政级别贪腐案件的发生数和涉案金额并统计不同刑期的案件\n分别是多少起。</span>");
    ...
    gtk_fixed_put(GTK_FIXED(stasticalview), leveltitle, 725, 253);

    GtkWidget * provincelabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(provincelabel), "<span foreground='#60646d' font_desc='Microsoft YaHei 15'>以案件发生地所属省份为条件分别统计某个时间段内各省份贪腐案件的发生数，涉案金额总数，并降序\n输出。</span>");
    ...
    gtk_fixed_put(GTK_FIXED(stasticalview), provincetitle, 725, 363);

    GtkWidget * reportlabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(reportlabel), "<span foreground='#60646d' font_desc='Microsoft YaHei 15'>统计媒体报道数最多的10个贪腐案件，输出案件编号、被告行政级别、主要罪名、涉案金额、刑事处罚\n和媒体报道次数，并降序输出。</span>");
    ...
    gtk_fixed_put(GTK_FIXED(stasticalview), reporttitle, 725, 473);

    GtkWidget * amountlabel = gtk_label_new("");
    gtk_label_set_markup(GTK_LABEL(amountlabel), "<span foreground='#60646d' font_desc='Microsoft YaHei 15'>统计涉案金额数最大的10个贪腐案件，输出案件编号、被告姓名、被告行政级别、主要罪名、涉案金额\n和刑事处罚，并降序输出。</span>");
    ...
    gtk_fixed_put(GTK_FIXED(stasticalview), amounttitle, 725, 583);

...
void on_case_name_and_level_query_clicked(GtkWidget * widget)
{
    ...
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "副科级", -1);
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "正科级", -1);
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "副处级", -1);
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "正处级", -1);
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "副厅级", -1);
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "正厅级", -1);
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "副部级", -1);
    gtk_list_store_append(level_store, &iter2);
    gtk_list_store_set(level_store, &iter2, 0, "正部级及以上", -1);
    ...
    gtk_table_attach_defaults(GTK_TABLE(table), levelcombo, 1, 2, 1, 2);
	...
	level = gtk_combo_box_get_active(GTK_COMBO_BOX(levelcombo)) + 65;
